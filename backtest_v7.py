...
def test_vol_scaling(df, target_vol=0.15, vol_window=20):
    df = df.copy()
...
if __name__ == "__main__":
    ...
    print("Volatility Scaling (Target Vol = 15%, max leverage = 1.0)")
    returns_train = test_vol_scaling(train_df)
    print("Train Metrics:", calculate_metrics(returns_train))
    
    returns_test = test_vol_scaling(test_df)
